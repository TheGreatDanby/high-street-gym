...
export function XMLUploadUsers({ onUploadSuccess }) {
  ...
  function uploadFile(e) {
    ...
    console.log("File to upload: ", file); // new log
    console.log("FormData: ", formData.get("xml-file")); // get the file from formData
    console.log(
      "🚀 ~ file: XMLUpload.jsx:26 ~ uploadFile ~ formData:",
      formData
    );

    // fetch(API_URL + "/classes/upload/xml?authKey=" + user.authenticationKey, {
